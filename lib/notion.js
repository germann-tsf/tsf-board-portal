...
async function fetchCommitteeMap() {
  // Fallback map for when the Committees DB isn't shared with the integration
  const COMMITTEE_NAMES = {
    '22984a2d-4690-80e0-ad63-d594867e1e86': 'Executive',
    '22984a2d-4690-8037-9063-f813dc539495': 'Finance',
    '22984a2d-4690-808d-99cf-f6e897b24cac': 'Fundraising',
    '22984a2d-4690-80d9-8ab1-d63bba23e5d5': 'Governance',
    '22984a2d-4690-80e3-9184-f41f8d8f3387': 'SHCP',
  }
  ...
  try {
    ...
    console.error('Error fetching committee map, using fallback:', error.message)
    // Use hardcoded fallback
    Object.assign(map, COMMITTEE_NAMES)
  }
