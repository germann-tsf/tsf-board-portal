...
async function fetchCommitteeMap() {
  ...
  try {
    let hasMore = true
    let cursor = undefined
    // Internal Committees data source (inside Board Member Database)
    const committeesDbId = '65cb9003-9289-4cc2-99a1-cdef9216a9d6'
    ...
    console.error('Error fetching committees (integration may need access):', error.message)
  }
  return map
}
